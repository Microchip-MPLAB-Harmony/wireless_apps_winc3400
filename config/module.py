...
def loadModule():
    ...
    appWincExampleConfComponent = Module.CreateComponent('appWincExampleConf', 'WINC Example Application Configuration', '/Wireless/System Services/', 'config/winc_example_app_conf.py')
