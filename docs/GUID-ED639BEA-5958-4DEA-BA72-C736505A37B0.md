...
In this demonstration, the WINC Driver will connect to a BSS and begin a TCP client socket connection to a remote server service.<br />This demonstration can be configured in the following ways in the source code.
