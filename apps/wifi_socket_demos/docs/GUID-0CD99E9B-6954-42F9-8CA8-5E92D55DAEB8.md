...
-   Under \\wireless\_apps\_winc1500\\apps, create a folder name for the project \(Ex: sample\_project\).
...
-   Go to the path \\wireless\_apps\_winc1500\\apps\{User project name\}\\firmware\\src.
...
-   Replace the following files with the files available in the AP scan example project<br />\\wireless\_apps\_winc1500\\apps\\ap\_scan\\firmware\\src
...
-   Go to \\wireless\_apps\_winc1500\\apps\{User project name\}\\firmware\\src
