...
4.  Enter the pass-key â€œ123456â€? on Bluetooth Pairing Request window and click Pair.
...
6.  Select â€œBattery Serviceâ€? to receive notifications for the battery level characteristic.
